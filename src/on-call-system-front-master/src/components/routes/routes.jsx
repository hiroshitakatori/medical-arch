...
import FacilityMyPage from "../view/pages/facilitys/mypage/MyPage";
import MyPage from "../view/pages/users/mypage/MyPage";
...
const routes = [
    {
        ...
        auth: true,
        ActiveMenuKey: "",
        component: <Dashboard title="Welcome To Dashboard" />
    },
    {
    ...
    },
    {
        ...
        auth: true,
        ActiveMenuKey: "",
        component: <FacilityReportDetails title="Facility Report List" />
    },
    {
    ...
    },
    {
        ...
        auth: true,
        ActiveMenuKey: "",
        component: <FacilityMyPage title="Report List" />
    },
    {
        path: PATH_FRONT.Mypage,
        layout: 'master',
        exact: true,
        auth: true,
        ActiveMenuKey: "",
